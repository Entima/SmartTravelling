...
<section class="jumbotron text-center">
    <div class="container">
        <h1 class="jumbotron-heading">Favourite place</h1>
    </div>
</section>
<div class="container">
    <div class="row">
    ...
    <li>${placeEntity.name}<img src="${placeEntity.photo}"/>
        <div class="container">
            <div class="row">
                ...
                <div class="col font-weight-bold"><a href = "/places/deletePlaces/${placeEntity.tripId}/${placeEntity.id}">Delete your place</a></div>
                <div class="col font-weight-bold"><a href = "/places/showPlaces/${placeEntity.id}">Details about your place</a></div>
            </div>
